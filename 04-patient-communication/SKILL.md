---
name: 04-patient-communication
description: "Patient communication. Use when patients need templated billing messages from posted facts, or replies need content-routing - no clinical content, no pressure beyond the published sequence, no hardship decisions."
---
...
**Autonomy tier:** Autonomous sends from approved templates; NO clinical content, no collection pressure beyond the published sequence, no hardship decisions
...
{
  "envelope_id": "uuid",
  "from_agent": "04-patient-communication",
